...
async def gen_thumb(videoid):
    ...
    arial = ImageFont.truetype("HeavenMusic/assets/font2.ttf", 30)
    font = ImageFont.truetype("HeavenMusic/assets/font.ttf", 30)
    title_font = ImageFont.truetype("HeavenMusic/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("HeavenMusic/assets/play_icons.png")
